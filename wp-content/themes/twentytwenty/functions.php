...
wp_enqueue_style( 'slick', get_template_directory_uri() . '/assets/css/slick.css', array(), 1 );
...
wp_register_script('masked', get_template_directory_uri() .'/assets/js/jquery.maskedinput.min.js');
wp_register_script('newscript', get_template_directory_uri() .'/assets/js/main.js');
wp_register_script('basescript', get_template_directory_uri() .'/assets/js/script.js');
...
function twentytwenty_customize_controls_enqueue_scripts() {
	...
	wp_enqueue_script( 'twentytwenty-customize', get_template_directory_uri() . '/assets/js/slick.min.js', array( 'slick.min.js' ), $theme_version, false );
	wp_enqueue_script( 'twentytwenty-customize', get_template_directory_uri() . '/assets/js/index.js', array( 'slick.min.js' ), $theme_version, false );
